...
class SiteReviewsSummaryShortcode extends Shortcode
{
    ...
    public function buildTemplate(array $args = [])
    {
        ...
        return glsr(Template::class)->build('templates/reviews-summary', [
            ...
            'context' => [
                ...
                'RatingSectionName' => $this->getRatingSectionName(),
            ],
        ]);
    }
     ...
     * @return string
     */
    protected function getRatingSectionName()
    {
        if (strpos($this->args['class'], 'location_rating') !== false) {
            return 'Location Rating';
        }
        if (strpos($this->args['class'], 'property_rating') !== false) {
            return 'Property Rating';
        }
        if (strpos($this->args['class'], 'community_rating') !== false) {
            return 'Community Rating';
        }
        if (strpos($this->args['class'], 'price_rating') !== false) {
            return 'Price Rating';
        }
